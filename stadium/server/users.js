...
const UsersRouter = (io) => {
  ...
  router
    ...
    .get(function (req, res, next) {
      const pageLimit = req.query.limit ? parseInt(req.query.limit) : 1000;
      ...
      console.log('GET /all-users - Pagination:', req.pagination);

      Users.findAll(req.pagination)
        .then((users) => {
          console.log('Users encontrados:', users.data?.length || 0);
          const response = {
            auth: true,
            users: users.data,
